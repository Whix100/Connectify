...
be removed, so no need for filters to prevent removing certus crystals instead of charged nether. Can be rotated with a
<ItemLink id="certus_quartz_wrench" /> in order to facilitate automation.

Can be used to create <ItemLink id="charged_nether_quartz_crystal" />
